...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #hexxcoincoinTEST\r");
            Send(hSocket, "WHO #hexxcoincoinTEST\r");
        } else
        {
        LogPrintf("JOIN #hexxcoincoin\n");
            // randomly join #hexxcoincoin00-#hexxcoincoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #hexxcoincoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #hexxcoincoin%02d\r", channel_number).c_str());
        };
