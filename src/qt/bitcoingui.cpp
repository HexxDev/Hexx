...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/hexxcoin"));
    setWindowIcon(QIcon(":icons/hexxcoin"));
#else
    //setUnifiedTitleAndToolBarOnMac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsInMenus);
#endif
    setObjectName("hexxcoin");
    setStyleSheet("#hexxcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/hexxcoin"), tr("&HexxNet"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/hexxcoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/hexxcoin_testnet"));
            setWindowIcon(QIcon(":icons/hexxcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/hexxcoin_testnet"));
#endif
            if(trayIcon)
            {
